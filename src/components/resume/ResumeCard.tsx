...
const ResumeCard: React.FC<ResumeCardProps> = ({ resume, onView, onDelete, onSetPrimary }) => {
          ...
          {onSetPrimary && (
            ...
            >
              {resume.isPrimary ? (
                ...
                <svg className="w-4 h-4 text-muted-foreground hover:text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
